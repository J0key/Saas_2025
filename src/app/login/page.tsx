      ...
      <div className='container'>
        ...
        <div className="section-heading ">
          ...
          <p className="section-description mt-5">
            Login to securely access your personalized dashboard, manage your profile, and continue where you left off
          </p>
        </div>
        ...
        <p className="text-sm text-gray-500 text-center mt-6">
          ...
          <a href="http://localhost:3000/register" className="text-[#001E80] font-medium hover:underline">
            Sign up
          </a>
        </p>
      </div>
